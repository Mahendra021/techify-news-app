...
class CustomSwitch extends StatefulWidget {
  ...
  final Widget? activeToggleIcon;
  final Widget? inactiveToggleIcon;
                    ...
                    children: <Widget>[
                      AnimatedOpacity(
                        ...
                        child: Container(
                          ...
                          child: widget.showOnOff ? _activeText : widget.activeIcon,
                        ),
                      ),
                      Align(
                        ...
                        child: AnimatedOpacity(
                          ...
                          child: Container(
                            ...
                            padding: const EdgeInsets.symmetric(horizontal: 4.0),
                            alignment: Alignment.centerRight,
                            child: widget.showOnOff ? _inactiveText : widget.inactiveIcon,
                          ),
                        ),
                      ),
                      Align(
                              ...
                              children: [
                                ...
                                Center(
                                  child: AnimatedOpacity(
                                    opacity: !widget.value ? 1.0 : 0.0,
                                    duration: widget.duration,
                                    child: widget.inactiveToggleIcon,
                                  ),
                                ),
                              ],
                            ),
